...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_h3bbqck', 'template_yl4dcsk', form.current, {
        publicKey: 'vkblkA9n8QPXRL7h4',
      })
      .then(
        () => {
          e.target.reset()
  ...
  return (
    <section className="contact section" id="contact">
        <h2 className="section__title">./contact.sh</h2>
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">quangminh27405@gmail.com</span>

                        <a href="mailto:quangminh27405@gmail.com.com" className="contact__button">Email me<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">QuangMinhNguyen27405</span>

                        <a href="https://github.com/QuangMinhNguyen27405" className="contact__button">My GitHub<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>  
            </div>

...
const Prompt = () => (
    <span className="home__prompt">
        <span className="prompt">visitor@quangminh27405.me</span>
...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h1 className="home__title">Quang Minh Nguyen
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <p className="home__description">"I am passionate about leveraging technology to drive innovation and efficiency."</p>

        <p className="home__line">
            <Prompt />
            <a href="#contact" className="home__cmd-link">./say-hello.sh</a>
